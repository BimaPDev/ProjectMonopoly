...
VALUES ($1, $2, $3, NULL)
RETURNING id, platform, username, profile_url, last_checked, followers, engagement_rate, growth_rate, posting_frequency, total_posts
`
...
SELECT id, platform, username, profile_url, last_checked, followers, engagement_rate, growth_rate, posting_frequency, total_posts FROM competitors
...
SELECT c.id, c.platform, c.username, c.profile_url, c.last_checked, c.followers, c.engagement_rate, c.growth_rate, c.posting_frequency, c.total_posts
FROM competitors c
...
SELECT id, platform, username, profile_url, last_checked, followers, engagement_rate, growth_rate, posting_frequency, total_posts
FROM competitors
WHERE id NOT IN (
